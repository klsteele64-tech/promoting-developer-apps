...
| Order | Agent | When |
|-------|-------|------|
| 1 | positioning-agent | Line, vs, must-not-claim missing |
...
| Agent | When |
|-------|------|
| docs-agent | Docs requested or missing |
| video-agent | Walkthrough / demo video |
| landing-agent | Landing, OG, or vs page |
| social-agent | Launch posts |
| changelog-agent | Ship notes |
...
| Agent | When |
|-------|------|
| play-store-agent | Google Play / Android |
