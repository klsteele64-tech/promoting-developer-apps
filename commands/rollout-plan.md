...
1. Load `skills/promoting-developer-apps/SKILL.md` and announce: `Using promoting-developer-apps (via /rollout-plan)`.
...
Dispatch **rollout-planner** (`skills/promoting-developer-apps/subagents/rollout-planner.md`). Show all four modes. Recommend one. Execute that playbook into a 14-day calendar.
