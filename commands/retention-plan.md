---
name: retention-plan
description: First-success, review timing, and win-back plan
---

**Parent router:** This is a slice of `/promote`. Enter through the parent skill — do not treat this command as a sibling skill.

1. Load `skills/promoting-developer-apps/SKILL.md` and announce: `Using promoting-developer-apps (via /retention-plan)`.
...
Dispatch **retention-agent** (`skills/promoting-developer-apps/subagents/retention-agent.md`). Inherit must-not-claim from positioning. Do not invent retention rates. Do not place ads or publish to stores.
