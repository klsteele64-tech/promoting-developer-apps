---
name: seo-cluster
description: Plan a pillar-and-support SEO article cluster
---

**Parent router:** This is a slice of `/promote`. Enter through the parent skill — do not treat this command as a sibling skill.

1. Load `skills/promoting-developer-apps/SKILL.md` and announce: `Using promoting-developer-apps (via /seo-cluster)`.
...
Dispatch **seo-cluster-agent** (`skills/promoting-developer-apps/subagents/seo-cluster-agent.md`). Do not promise rankings. Mark guessed queries INFERRED.
