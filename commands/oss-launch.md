---
name: oss-launch
description: Plan an OSS library or CLI launch
---

**Parent router:** This is a slice of `/promote`. Enter through the parent skill — do not treat this command as a sibling skill.

1. Load `skills/promoting-developer-apps/SKILL.md` and announce: `Using promoting-developer-apps (via /oss-launch)`.
...
Dispatch **oss-launch-agent** (`skills/promoting-developer-apps/subagents/oss-launch-agent.md`). Inherit must-not-claim from positioning. Performance numbers or testimonials → dispatch **claims-agent**. Do not place ads or publish to stores.
