---
name: write-positioning
description: Write the positioning line, vs matrix, and must-not-claim list
---

**Parent router:** This is a slice of `/promote`. Enter through the parent skill — do not treat this command as a sibling skill.

1. Load `skills/promoting-developer-apps/SKILL.md` and announce: `Using promoting-developer-apps (via /write-positioning)`.
...
Dispatch **positioning-agent** (`skills/promoting-developer-apps/subagents/positioning-agent.md`). Do not place ads or publish to stores.
