# Application scenario (reference skill)

Product (fixed fixture, do not invent extra facts):

- Name: RelayBoard
- Job: Indie SaaS founders drop GitHub issues into a public roadmap
- URL: https://relayboard.example
- Audience: solo SaaS founders
- Offer: freemium, Pro $12/mo
...
- Intensity = Whisper or Signal (not Blitz)
