...
Docs, video, stores, locale, pricing, SEO cluster, landing, social, email, funding, and the other slices are **subagents** of that skill (`subagents/`), not extra `skills/*` packages. See `references/subagent-index.md`.
